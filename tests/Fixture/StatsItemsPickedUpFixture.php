...
/**
 * StatsItemsPickedUpFixture
 *
 */
class StatsItemsPickedUpFixture extends TestFixture
{
     ...
     * @var string
     */
    public $table = 'stats_items_picked_up';
    ...
    public $fields = [
        ...
        '_constraints' => [
            ...
            'Stats_items_picked_up_ibfk_1' => ['type' => 'foreign', 'columns' => ['uuid'], 'references' => ['stats_players', 'uuid'], 'update' => 'cascade', 'delete' => 'cascade', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
