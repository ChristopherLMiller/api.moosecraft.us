...
/**
 * StatsTimesKickedFixture
 *
 */
class StatsTimesKickedFixture extends TestFixture
{
     ...
     * @var string
     */
    public $table = 'stats_times_kicked';
    ...
    public $fields = [
        ...
        '_constraints' => [
            ...
            'Stats_times_kicked_ibfk_1' => ['type' => 'foreign', 'columns' => ['uuid'], 'references' => ['stats_players', 'uuid'], 'update' => 'cascade', 'delete' => 'cascade', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
