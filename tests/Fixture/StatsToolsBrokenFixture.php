...
/**
 * StatsToolsBrokenFixture
 *
 */
class StatsToolsBrokenFixture extends TestFixture
{
     ...
     * @var string
     */
    public $table = 'stats_tools_broken';
    ...
    public $fields = [
        ...
        '_constraints' => [
            ...
            'Stats_tools_broken_ibfk_1' => ['type' => 'foreign', 'columns' => ['uuid'], 'references' => ['stats_players', 'uuid'], 'update' => 'cascade', 'delete' => 'cascade', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
