 ...
 *
 */
class StatsTradesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        '_constraints' => [
            ...
            'Stats_trades_ibfk_1' => ['type' => 'foreign', 'columns' => ['uuid'], 'references' => ['stats_players', 'uuid'], 'update' => 'cascade', 'delete' => 'cascade', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
